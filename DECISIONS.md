...
**Status:** active.
**Where:** `ROADMAP.md` → "Next — production-memory block"; ops-side dreaming pass in `~/chief-of-staff/ROADMAP.md` #19; AppKeep shared instance in AppKeep `DECISIONS_LOG.md` D.104.
